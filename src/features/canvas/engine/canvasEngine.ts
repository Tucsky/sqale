...
import { applyFurniturePaintToSceneObject, snapValue, type EngineFabricObject } from '@/features/canvas/engine/canvasObjects'
import { DraftOverlays, type DraftHandleObject } from '@/features/canvas/engine/draftOverlays'
import { moveLayerToBack, moveLayerToFront, removeLayer, setFurnitureFillColor, setLayerOpacity } from '@/features/floors/model/floorActions'
 ...
 * splitting adds indirection and increases desync risk during draw/calibration mode transitions.
 */
